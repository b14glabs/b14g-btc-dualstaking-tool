...
const createOrder_1 = require("./src/createOrder");
const constant_1 = require("./src/constant");
const createFairShareOrder_1 = require("./src/createFairShareOrder");
...
program
    ...
    .requiredOption("-bst, --btcStakingType <btcStakingType>", "BTC staking strategy type, choose between 1~2. 1) Merge Order 2) Fair Share ")
    ...
    .requiredOption("-corePriKey, --coreprivatekey <coreprivateKey>", "Core private key used to create orders and receive rewards in b14g marketplace")
    .requiredOption("-rePortion, --rewardportion <rewardportion>", "Reward sharing percent for BTC stakers (decimal = 6). e.g 50000000 = 50%")
    ...
    if (args.btcStakingType == 1) {
        rewardAddress = yield (0, createOrder_1.createOrder)(args.rewardportion, args.coreprivatekey);
    }
    else {
        rewardAddress = yield (0, createFairShareOrder_1.createFairShareOrder)(args.coreprivatekey);
    }
